...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Footer Contact Title', 'options_check'),
		'desc' => __('Enter the title for the two column footer contact info area', 'options_check'),
		'id' => 'fc_title',
		'std' => '',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __('Footer Column 1 Title', 'options_check'),
		'desc' => __('Enter the title for the first column', 'options_check'),
		'id' => 'fc1_title',
		'std' => '',
		'type' => 'text'
	);	
	
	// Footer Column 1 Tele 1
	$options[] = array(
		'name' => __('Footer Column 1 Tele 1', 'options_check'),
		'desc' => __('Enter the first telephone number  for column 1', 'options_check'),
		'id' => 'fc1_tele1',
		'std' => '',
		'type' => 'text'
	);	
	
	// Footer Column 1 Tele 2
	$options[] = array(
		'name' => __('Footer Column 1 Tele 2', 'options_check'),
		'desc' => __('Enter the second telephone number  for column 1', 'options_check'),
		'id' => 'fc1_tele2',
		'std' => '',
		'type' => 'text'
	);
	
	// Footer Column 1 Address 1
	$options[] = array(
		'name' => __('Footer Column 1 Address 1', 'options_check'),
		'desc' => __('Enter the first address for column 1', 'options_check'),
		'id' => 'fc1_addy1',
		'std' => '',
		'type' => 'textarea'
	);	
	
	// Footer Column 1 Address 2
	$options[] = array(
		'name' => __('Footer Column 1 Address 2', 'options_check'),
		'desc' => __('Enter the second address for column 1', 'options_check'),
		'id' => 'fc1_addy2',
		'std' => '',
		'type' => 'textarea'
	);	
	...
	$options[] = array(
		'name' => __('Footer Column 2 Title', 'options_check'),
		'desc' => __('Enter the title for the second column', 'options_check'),
		'id' => 'fc2_title',
		'std' => '',
		'type' => 'text'
	);	
	
	// Footer Column 2 Tele 1
	$options[] = array(
		'name' => __('Footer Column 2 Tele 1', 'options_check'),
		'desc' => __('Enter the first telephone number for column 2', 'options_check'),
		'id' => 'fc2_tele1',
		'std' => '',
		'type' => 'text'
	);	
	
	// Footer Column 2 Tele 2
	$options[] = array(
		'name' => __('Footer Column 2 Tele 2', 'options_check'),
		'desc' => __('Enter the second telephone number for column 2', 'options_check'),
		'id' => 'fc2_tele2',
		'std' => '',
		'type' => 'text'
	);	
	
	// Footer Column 2 Address 1
	$options[] = array(
		'name' => __('Footer Column 2 Address 1', 'options_check'),
		'desc' => __('Enter the first address for column 2', 'options_check'),
		'id' => 'fc2_addy1',
		'std' => '',
		'type' => 'textarea'
	);	
	
	// Footer Column 2 Address 2
	$options[] = array(
		'name' => __('Footer Column 2 Address 2', 'options_check'),
		'desc' => __('Enter the second address for column 2', 'options_check'),
		'id' => 'fc2_addy2',
		'std' => '',
		'type' => 'textarea'
	);	
	*/	
	...
	$options[] = array(
		...
		'desc' => __('Enter the URL for your Facebook profile', 'options_check'),
		'id' => 'rmc_facebook',
		'std' => '',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __('Facebook Position', 'options_check'),
		'desc' => __('1 is first, 5 is last', 'options_check'),
		'id' => 'social_order_1',
		'std' => 'one',
		'type' => 'select',
		'class' => 'mini social_select', //mini, tiny, small
		'options' => $test_array
	);
	...
	$options[] = array(
		...
		'desc' => __('Enter the URL for your  Google+ profile', 'options_check'),
		'id' => 'rmc_google',
		'std' => '',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __('Google+ Position', 'options_check'),
		'desc' => __('1 is first, 5 is last', 'options_check'),
		'id' => 'social_order_2',
		'std' => 'two',
		'type' => 'select',
	...
	$options[] = array(
		...
		'desc' => __('Enter the URL for your Instagram profile', 'options_check'),
		'id' => 'rmc_instagram',
		'std' => '',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __('Instagram Position', 'options_check'),
		'desc' => __('1 is first, 5 is last', 'options_check'),
		'id' => 'social_order_3',
		'std' => 'three',
		'type' => 'select',
	...
	$options[] = array(
		...
		'desc' => __('Enter the URL for your Pinterest profile', 'options_check'),
		'id' => 'rmc_pinterest',
		'std' => '',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __('Pinterest Position', 'options_check'),
		'desc' => __('1 is first, 5 is last', 'options_check'),
		'id' => 'social_order_4',
		'std' => 'four',
		'type' => 'select',
	...
	$options[] = array(
		...
		'desc' => __('Enter the URL for your YouTube profile', 'options_check'),
		'id' => 'rmc_youtube',
		'std' => '',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __('YouTube Position', 'options_check'),
		'desc' => __('1 is first, 5 is last', 'options_check'),
		'id' => 'social_order_5',
		'std' => 'five',
		'type' => 'select',
	...
	*/
	...
	// Footer Text 1 
	$options[] = array(
		'name' => __('Footer Text Line 1', 'options_check'),
		'desc' => __('First line of text in the bottom right of the footer.', 'options_check'),
		'id' => 'odl_footer_txt_1',
		'std' => '',
		'type' => 'text'
	);
	...
	// Footer Text 2
	$options[] = array(
		'name' => __('Footer Text Line 2', 'options_check'),
		'desc' => __('First line of text in the bottom right of the footer.', 'options_check'),
		'id' => 'odl_footer_txt_2',
		'std' => '',
		'type' => 'textarea'
	...
	// Footer Text 3
	$options[] = array(
		'name' => __('Footer Text Line 3', 'options_check'),
		'desc' => __('First line of text in the bottom right of the footer.', 'options_check'),
		'id' => 'odl_footer_txt_3',
		'std' => '',
		'type' => 'textarea'
	...
	$options[] = array(
		'name' => __('Home Posts', 'options_check'),
		'desc' => __('Select the number of News posts to appear on the homepage.', 'options_check'),
		'id' => 'rmchf_home_posts',
		'std' => 'three',
		'type' => 'select',
